...
export default defineConfig({
    ...
    plugins: [
        ...
        nodePolyfills({
            // Ref parser and Ono use these browser shims even for in-memory local references.
    ...
    resolve: {
        ...
        // 根 worktree 重新解析依赖后 react 可能被提升到仓库根 node_modules，导致
        // nodePolyfills 的 process shim 从 react 所在目录无法解析；统一用 web 自己的 react。
