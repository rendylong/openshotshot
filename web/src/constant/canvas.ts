...
export const NODE_DEFAULT_SIZE = {
    ...
    [CanvasNodeType.File]: { width: 360, height: 240, get title() { return i18n.t("canvas.nodeTypes.file"); } },
...
export const NODE_SPECS = {
    ...
    [CanvasNodeType.File]: {
        width: 360, height: 240, get title() { return NODE_DEFAULT_SIZE[CanvasNodeType.File].title; },
        metadata: { content: "", status: "idle" },
    },
