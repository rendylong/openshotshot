...
import type { ByokTextModelConfig } from "./pi-agent-types";
...
export const PI_PROVIDER_ID = "shotshot-local";
...
export function buildModelsFromConfig(config: ByokTextModelConfig, providerId: string = PI_PROVIDER_ID): { models: Models; model: Model<any> } {
