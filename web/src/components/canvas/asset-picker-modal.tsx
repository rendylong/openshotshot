...
export function AssetPickerModal({ open, onInsert, onClose }: Props) {
    ...
    return (
        <Modal title={t("canvas.assetPicker.title")} open={open} onCancel={onClose} footer={null} centered width={MODAL_WIDTH.lg} destroyOnHidden styles={{ body: { padding: "0 24px 24px", minHeight: 480 } }}>
    ...
    return (
        <div className="space-y-4">
            ...
            {visible.length ? (
                ...
                <EmptyState icon={Image} title={t("canvas.assetPicker.empty")} />
            )}
